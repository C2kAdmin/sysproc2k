...
if (defined('SYSTEC_INSTANCE_PATH')) {
    ...
    // fallback: apuntar a cliente1 (mientras estamos en single-cliente)
    $root  = realpath(__DIR__ . '/../../../..'); // -> /syspro/SysTec 
    $guess = $root ? ($root . '/_clients/cliente1/tec/config/instance.php') : '';
    $INSTANCE_PATH = ($guess && is_file($guess)) ? $guess : (__DIR__ . '/instance.php');
}
